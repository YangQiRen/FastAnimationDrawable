...
public class AnimationsContainer {
    ...
    private int resId = R.array.bullet_anim; //图片资源
    ...
    //获取单例
    public static AnimationsContainer getInstance(int resId, int fps, boolean oneShot) {
        if ( mInstance == null )
            mInstance = new AnimationsContainer();
        mInstance.setResId(resId, fps, oneShot);
        return mInstance;
    }

    public void setResId(int resId, int fps, boolean oneShot) {
        this.resId = resId;
        this.FPS = fps;
